...
<body>
<body>
    <h1 class="featureTitle">Technical Staff Details</h1>
    <div class="feature">
        <div class="topicContent">
                <h2 class="topicTitle">Welcome, <?php echo $technicalStaffData[0]['tech_fname'] . ' ' . $technicalStaffData[0]['tech_mname'] . ' ' . $technicalStaffData[0]['tech_lname']; ?>!</h2>
