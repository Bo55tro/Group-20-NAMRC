<!-- Adding certification requirements still in process by ariba -->
<!DOCTYPE html>
...
<form method="post" action="process_addrequirements.php">  <!-- added a page of processing - done by Ariba !-->
    <div>
